...
class GenericFrozen():
  ...
  def __init__(self):
    ...
    self.easy_empty_env_v0 = init_for_test([0,5], n_clutter=4)
    self.easy_empty_env_v0.__name__ = "easy_empty_env_v0"

    self.easy_empty_env_v1 = init_for_test([15,5], n_clutter=4)
    self.easy_empty_env_v1.__name__ = "easy_empty_env_v1"

    self.easy_empty_env_v2 = init_for_test([5,0], n_clutter=4)
    self.easy_empty_env_v2.__name__ = "easy_empty_env_v2"

    self.medium_empty_env_v0 = init_for_test([1,24], n_clutter=4)
    self.medium_empty_env_v0.__name__ = "medium_empty_env_v0"

    self.medium_empty_env_v1 = init_for_test([24,1], n_clutter=4)
...
register_test_env(all_frozen_envs.easy_empty_env_v0, "Frozen", "easy")
register_test_env(all_frozen_envs.easy_empty_env_v1, "Frozen", "easy")
register_test_env(all_frozen_envs.easy_empty_env_v2, "Frozen", "easy")
register_test_env(all_frozen_envs.medium_empty_env_v0, "Frozen", "medium")
register_test_env(all_frozen_envs.medium_empty_env_v1, "Frozen", "medium")
